...
class BehaviorAggressionFearSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Behavior::factory()->create([
            ...
            "description" =>
                "Behavior of the dog versus the behavior of another",
            "type" => "aggression_fear",
        ]);
        ...
        Behavior::factory()->create([
            "name" =>
                "Does your dog exhibit any of these behaviors when meeting new people? Please select all that apply.",
        ...
        Behavior::factory()->create([
            "name" =>
                "Does your dog exhibit any of these behaviors when meeting new dogs? Please select all that apply.",
        ...
        Behavior::factory()->create([
            "name" =>
                "If your dog has ever bitten a person, how many times has this occured?",
        ...
        Behavior::factory()->create([
            "name" =>
                "If your dog has ever bitten a dog, how many times has this occured?",

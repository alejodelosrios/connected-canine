 <!-- Navbar -->
  <nav class="top-0 my-3 mt-4 shadow-none navbar navbar-expand-lg position-absolute z-index-3 w-100 navbar-transparent">
    <div class="container">
      <a class="text-white navbar-brand font-weight-bolder ms-lg-0 ms-3" href="../pages/dashboards/default.html">
        Soft UI Dashboard
      </a>
      ...
      <div class="pt-3 pb-2 collapse navbar-collapse w-100 py-lg-0" id="navigation">
        <ul class="mx-auto navbar-nav navbar-nav-hover">
          <li class="mx-2 nav-item dropdown dropdown-hover">
            <a role="button" class="cursor-pointer nav-link ps-2 d-flex justify-content-between align-items-center " id="dropdownMenuPages" data-bs-toggle="dropdown" aria-expanded="false">
              Pages
            ...
            <div class="p-3 mt-0 dropdown-menu dropdown-menu-animation dropdown-xl border-radius-xl mt-lg-3" aria-labelledby="dropdownMenuPages">
                    ...
                    <div class="col-4 position-relative">
                      <div class="px-0 dropdown-header text-dark font-weight-bolder d-flex align-items-center">
                        <div class="d-inline-block">
                          <div class="text-center icon icon-shape icon-xs border-radius-md bg-gradient-primary me-2 d-flex align-items-center justify-content-center">
                      ...
                      <div class="px-0 mt-3 dropdown-header text-dark font-weight-bolder d-flex align-items-center">
                        <div class="d-inline-block">
                          <div class="text-center icon icon-shape icon-xs border-radius-md bg-gradient-primary me-2 d-flex align-items-center justify-content-center ps-0">
          ...
          <li class="mx-2 nav-item dropdown dropdown-hover">
            <a role="button" class="cursor-pointer nav-link ps-2 d-flex justify-content-between align-items-center " id="dropdownMenuAccount" data-bs-toggle="dropdown" aria-expanded="false">
              Authentication
              <img src=" ../assets/img/down-arrow-dark.svg " alt="down-arrow" class="arrow ms-1 d-lg-block d-none">
              <img src="../assets/img/down-arrow-dark.svg" alt="down-arrow" class="arrow ms-1 d-lg-none d-block">
            </a>
            <div class="p-3 mt-0 dropdown-menu dropdown-menu-animation dropdown-lg border-radius-xl mt-lg-3" aria-labelledby="dropdownMenuAccount">
              <div class="row d-none d-lg-flex">
                <div class="col-6">
                  <div class="py-6 h-100 w-100 d-flex border-radius-lg position-relative dropdown-image" style="background-image:url('../assets/img/curved-images/curved8.jpg')">
                    ...
                    <div class="text-center text-white d-flex justify-content-center align-items-center font-weight-bold w-100 z-index-1 flex-column">
                      <div class="text-center bg-white shadow icon icon-shape rounded-circle">
                        <i class="text-lg ni ni-diamond text-primary text-gradient" aria-hidden="true"></i>
                      </div>
                      <span class="mt-2 text-lg">Explore our<br>utilities pages</span>
                    </div>
                  </div>
                </div>
                <div class="col-6 ps-0 d-flex justify-content-center flex-column">
                  <ul class="list-group">
                    <li class="p-0 border-0 nav-item dropdown dropdown-hover dropdown-subitem list-group-item">
                      <a class="mb-1 dropdown-item border-radius-md ps-3 d-flex align-items-center justify-content-between" id="dropdownSignIn">
                        <span>Sign In</span>
                      ...
                      <div class="px-2 py-3 mt-0 dropdown-menu" aria-labelledby="dropdownSignIn">
                        <a class="mb-1 dropdown-item ps-3 border-radius-md" href="../pages/authentication/signin/basic.html">
                          <span>Basic</span>
                        </a>
                        <a class="mb-1 dropdown-item ps-3 border-radius-md" href="../pages/authentication/signin/cover.html">
                          <span>Cover</span>
                        </a>
                        <a class="mb-1 dropdown-item ps-3 border-radius-md" href="../pages/authentication/signin/illustration.html">
                          <span>Illustration</span>
                        </a>
                      </div>
                    </li>
                    <li class="p-0 border-0 nav-item dropdown dropdown-hover dropdown-subitem list-group-item">
                      <a class="mb-1 dropdown-item border-radius-md ps-3 d-flex align-items-center justify-content-between" id="dropdownSignUp">
                        <span>Sign Up</span>
                        <img src="../assets/img/down-arrow.svg" alt="down-arrow" class="arrow">
                      </a>
                      <div class="px-2 py-3 mt-0 dropdown-menu" aria-labelledby="dropdownSignUp">
                        <a class="mb-1 dropdown-item ps-3 border-radius-md" href="../pages/authentication/signup/basic.html">
                          <span>Basic</span>
                        </a>
                        <a class="mb-1 dropdown-item ps-3 border-radius-md" href="../pages/authentication/signup/cover.html">
                          <span>Cover</span>
                        </a>
                        <a class="mb-1 dropdown-item ps-3 border-radius-md" href="../pages/authentication/signup/illustration.html">
                          <span>Illustration</span>
                        </a>
                      </div>
                    </li>
                    <li class="p-0 border-0 nav-item dropdown dropdown-hover dropdown-subitem list-group-item">
                      <a class="mb-1 dropdown-item border-radius-md ps-3 d-flex align-items-center justify-content-between" id="dropdownPasswordReset">
                        <span>Reset Password</span>
                        <img src="../assets/img/down-arrow.svg" alt="down-arrow" class="arrow">
                      </a>
                      <div class="px-2 py-3 mt-0 dropdown-menu" aria-labelledby="dropdownPasswordReset">
                        <a class="mb-1 dropdown-item ps-3 border-radius-md" href="../pages/authentication/reset/basic.html">
                          <span>Basic</span>
                        </a>
                        <a class="mb-1 dropdown-item ps-3 border-radius-md" href="../pages/authentication/reset/cover.html">
                          <span>Cover</span>
                        </a>
                        <a class="mb-1 dropdown-item ps-3 border-radius-md" href="../pages/authentication/reset/illustration.html">
                          <span>Illustration</span>
                        </a>
                      </div>
                    </li>
                    <li class="p-0 border-0 nav-item dropdown dropdown-hover dropdown-subitem list-group-item">
                      <a class="mb-1 dropdown-item border-radius-md ps-3 d-flex align-items-center justify-content-between" id="dropdownLock">
                        <span>Lock</span>
                        <img src="../assets/img/down-arrow.svg" alt="down-arrow" class="arrow">
                      </a>
                      <div class="px-2 py-3 mt-0 dropdown-menu" aria-labelledby="dropdownLock">
                        <a class="mb-1 dropdown-item ps-3 border-radius-md" href="../pages/authentication/lock/basic.html">
                          <span>Basic</span>
                        </a>
                        <a class="mb-1 dropdown-item ps-3 border-radius-md" href="../pages/authentication/lock/cover.html">
                          <span>Cover</span>
                        </a>
                        <a class="mb-1 dropdown-item ps-3 border-radius-md" href="../pages/authentication/lock/illustration.html">
                          <span>Illustration</span>
                        </a>
                      </div>
                    </li>
                    <li class="p-0 border-0 nav-item dropdown dropdown-hover dropdown-subitem list-group-item">
                      <a class="mb-1 dropdown-item border-radius-md ps-3 d-flex align-items-center justify-content-between" id="dropdown2fa">
                        <span>2-Step Verification</span>
                        <img src="../assets/img/down-arrow.svg" alt="down-arrow" class="arrow">
                      </a>
                      <div class="px-2 py-3 mt-0 dropdown-menu" aria-labelledby="dropdown2fa">
                        <a class="mb-1 dropdown-item ps-3 border-radius-md" href="../pages/authentication/verification/basic.html">
                          <span>Basic</span>
                        </a>
                        <a class="mb-1 dropdown-item ps-3 border-radius-md" href="../pages/authentication/verification/cover.html">
                          <span>Cover</span>
                        </a>
                        <a class="mb-1 dropdown-item ps-3 border-radius-md" href="../pages/authentication/verification/illustration.html">
                          <span>Illustration</span>
                        </a>
                      </div>
                    </li>
                    <li class="p-0 border-0 nav-item dropdown dropdown-hover dropdown-subitem list-group-item">
                      <a class="mb-1 dropdown-item border-radius-md ps-3 d-flex align-items-center justify-content-between" id="dropdownError">
                        <span>Error</span>
                        <img src="../assets/img/down-arrow.svg" alt="down-arrow" class="arrow">
                      </a>
                      <div class="px-2 py-3 mt-0 dropdown-menu" aria-labelledby="dropdownError">
                        <a class="mb-1 dropdown-item ps-3 border-radius-md" href="../pages/authentication/error/404.html">
                          <span>404</span>
                        </a>
                        <a class="mb-1 dropdown-item ps-3 border-radius-md" href="../pages/authentication/error/500.html">
                          <span>500</span>
                        </a>
                      </div>
                    </li>
          ...
          <li class="mx-2 nav-item dropdown dropdown-hover">
            <a role="button" class="cursor-pointer nav-link ps-2 d-flex justify-content-between align-items-center " id="dropdownMenuBlocks" data-bs-toggle="dropdown" aria-expanded="false">
              Applications
              <img src=" ../assets/img/down-arrow-dark.svg " alt="down-arrow" class="arrow ms-1 d-lg-block d-none">
              <img src="../assets/img/down-arrow-dark.svg" alt="down-arrow" class="arrow ms-1 d-lg-none d-block">
            </a>
            <div class="p-3 mt-0 dropdown-menu dropdown-menu-animation dropdown-md dropdown-md-responsive border-radius-lg mt-lg-3" aria-labelledby="dropdownMenuBlocks">
              <div class="d-none d-lg-block">
                <ul class="list-group">
                  <li class="p-0 border-0 nav-item dropdown dropdown-hover dropdown-subitem list-group-item">
                    <a class="py-2 dropdown-item ps-3 border-radius-md" href="../pages/applications/kanban.html">
                      <div class="d-flex">
                  ...
                  <li class="p-0 border-0 nav-item dropdown dropdown-hover dropdown-subitem list-group-item">
                    <a class="py-2 dropdown-item ps-3 border-radius-md" href="../pages/applications/wizard.html">
                      <div class="d-flex">
                        <div class="h-10 mt-1 icon me-3 d-flex">
                  ...
                  <li class="p-0 border-0 nav-item dropdown dropdown-hover dropdown-subitem list-group-item">
                    <a class="py-2 dropdown-item ps-3 border-radius-md" href="../pages/applications/datatables.html">
                      <div class="d-flex">
                        <div class="h-10 mt-1 icon me-3 d-flex">
                  ...
                  <li class="p-0 border-0 nav-item dropdown dropdown-hover dropdown-subitem list-group-item">
                    <a class="py-2 dropdown-item ps-3 border-radius-md" href="../pages/applications/calendar.html">
                      <div class="d-flex">
                        <div class="h-10 mt-1 icon me-3 d-flex">
          ...
          <li class="mx-2 nav-item dropdown dropdown-hover">
            <a role="button" class="cursor-pointer nav-link ps-2 d-flex justify-content-between align-items-center " id="dropdownMenuEcommerce" data-bs-toggle="dropdown" aria-expanded="false">
              Ecommerce
              <img src=" ../assets/img/down-arrow-dark.svg  " alt="down-arrow" class="arrow ms-1 d-lg-block d-none">
              <img src="../assets/img/down-arrow-dark.svg" alt="down-arrow" class="arrow ms-1 d-lg-none d-block">
            </a>
            <div class="p-3 mt-0 dropdown-menu dropdown-menu-animation dropdown-lg border-radius-xl mt-lg-3" aria-labelledby="dropdownMenuEcommerce">
              <div class="row d-none d-lg-block">
                <div class="px-4 py-2 col-12">
                  <div class="row">
          ...
          <li class="mx-2 nav-item dropdown dropdown-hover">
            <a role="button" class="cursor-pointer nav-link ps-2 d-flex justify-content-between align-items-center " id="dropdownMenuDocs" data-bs-toggle="dropdown" aria-expanded="false">
              Docs
              <img src=" ../assets/img/down-arrow-dark.svg " alt="down-arrow" class="arrow ms-1 d-lg-block d-none">
              <img src="../assets/img/down-arrow-dark.svg" alt="down-arrow" class="arrow ms-1 d-lg-none d-block">
            </a>
            <div class="p-3 mt-0 dropdown-menu dropdown-menu-animation dropdown-lg mt-lg-3 border-radius-lg" aria-labelledby="dropdownMenuDocs">
              <div class="d-none d-lg-block">
                <ul class="list-group">
                  <li class="p-0 border-0 nav-item list-group-item">
                    <a class="py-2 dropdown-item ps-3 border-radius-md" href="https://www.creative-tim.com/learning-lab/bootstrap/overview/soft-ui-dashboard">
                      <div class="d-flex">
                        <div class="h-10 mt-1 icon me-3 d-flex">
                        ...
                        <div>
                          <h6 class="p-0 dropdown-header text-dark font-weight-bolder d-flex align-items-center">Getting Started</h6>
                  ...
                  <li class="p-0 border-0 nav-item list-group-item">
                    <a class="py-2 dropdown-item ps-3 border-radius-md" href="https://www.creative-tim.com/learning-lab/bootstrap/colors/soft-ui-dashboard">
                      <div class="d-flex">
                        <div class="h-10 mt-1 icon me-3 d-flex">
                        ...
                        <div>
                          <h6 class="p-0 dropdown-header text-dark font-weight-bolder d-flex align-items-center">Foundation</h6>
                  ...
                  <li class="p-0 border-0 nav-item list-group-item">
                    <a class="py-2 dropdown-item ps-3 border-radius-md" href="https://www.creative-tim.com/learning-lab/bootstrap/alerts/soft-ui-dashboard">
                      <div class="d-flex">
                        <div class="h-10 mt-1 icon me-3 d-flex">
                        ...
                        <div>
                          <h6 class="p-0 dropdown-header text-dark font-weight-bolder d-flex align-items-center">Components</h6>
                  ...
                  <li class="p-0 border-0 nav-item list-group-item">
                    <a class="py-2 dropdown-item ps-3 border-radius-md" href="https://www.creative-tim.com/learning-lab/bootstrap/datepicker/soft-ui-dashboard">
                      <div class="d-flex">
                        <div class="h-10 mt-1 icon me-3 d-flex">
                          <svg class="text-secondary" width="16px" height="16px" viewBox="0 0 40 44" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        ...
                        <div>
                          <h6 class="p-0 dropdown-header text-dark font-weight-bolder d-flex align-items-center">Plugins</h6>
                  ...
                  <li class="p-0 border-0 nav-item list-group-item">
                    <a class="py-2 dropdown-item ps-3 border-radius-md" href="https://www.creative-tim.com/learning-lab/bootstrap/utilities/soft-ui-dashboard">
                      <div class="d-flex">
                        <div class="h-10 mt-1 icon me-3 d-flex">
                          <svg class="text-secondary" width="16px" height="16px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        ...
                        <div>
                          <h6 class="p-0 dropdown-header text-dark font-weight-bolder d-flex align-items-center">Utility Classes</h6>
        ...
        <ul class="navbar-nav d-lg-block d-none">
          <li class="nav-item">
            <a href="https://www.creative-tim.com/product/soft-ui-dashboard-pro" class="mb-0 btn btn-sm bg-gradient-primary btn-round me-1" onclick="smoothToPricing('pricing-soft-ui')">Buy Now</a>
          </li>
        </ul>
      </div>
    </div>

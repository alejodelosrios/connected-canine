<div class="py-2">
    ...
    @if (request()->is('admin/*'))
        ...
        <a href="{{ route('admin.pet-medications', $pet) }}"
            class="mx-1 btn btn-primary btn-sm @if (request()->is('admin/pets/*/medications') || request()->is('admin/pets/*/medications/*/details')) active @endif">Vet & Medical</a>
    @else
        ...
        <a href="{{ route('pet.medications', $pet) }}"
            class="mx-1 btn btn-primary btn-sm @if (request()->is('pets/*/medications')|| request()->is('pets/*/medications/add')|| request()->is('pets/*/medications/*/update')) active @endif">Vet & Medical</a>
    @endif
    </div>
</div>

<div class="py-2">
    ...
    @if (request()->is('admin/*'))
        ...
        <a href="{{ route('admin.pet-veterinarian', $pet) }}"
            class="mx-1 btn btn-primary btn-sm @if (request()->is('admin/pets/*/veterinarian')) active @endif">Vet & Medical</a>
    ...
    @else
        ...
        <a href="{{ route('veterinarian', $pet) }}"
            class="mx-1 btn btn-primary btn-sm @if (request()->is('pet/*/veterinarian')) active @endif">Vet & Medical</a>

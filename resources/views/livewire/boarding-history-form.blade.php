    ...
    <form wire:submit.prevent="save" role="form text-left">
        ...
        <div class="mt-5">
            <h6 :class="  {'text-muted': !$refs.attended_true.checked}">3) Has your dog ever been asked not to come
                back to doggy daycare for behavioral reasons?</h6>
        ...
        <div class="mt-3">
            <h6 :class="{'text-muted': !$refs.accomodations_true.checked || !$refs.attended_true.checked}">
        ...
        <div class="mt-5">
            <h6 :class="!$refs.attended_true.checked && 'text-muted'">Anything to add about doggy daycare or
                boarding:
            </h6>

                ...
                <tbody>
                    @forelse ($users as $user)
                        <tr>
                            ...
                            <td class="align-middle text-center text-sm">
                                <span
                                    class=" text-xs font-weight-bold text-capitalize">{{ $user->name }}</span>
                            </td>
                            <td class="align-middle text-center">
                                <span
                                    class=" text-xs font-weight-bold">{{ $user->lastname }}</span>
                            </td>
                            <td class="align-middle text-center">
                                <span
                                    class=" text-xs font-weight-bold">{{ $user->email }}</span>
                            </td>
                            <td class="align-middle text-center">
